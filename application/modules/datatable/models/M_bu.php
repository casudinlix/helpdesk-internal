...
class M_bu extends CI_Model {
	var $table = 'm_bu';

	var $column_order = array('idBu','buName','address','phone','email','addDate','editDate','updateBy',''); //set column field database for datatable orderable
